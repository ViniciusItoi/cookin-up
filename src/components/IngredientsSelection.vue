...
export default {
  ...
  props: {
    categorias: { type: Array as () => ICategoria[], required: true }
  },
  components: { CategoryCard, MainButton },
  emits: ['addIngredient', 'removeIngredient', 'ToggleRecipes']
}
</script>
<template>
  ...
  <MainButton texto="Buscar receitas!" @click="$emit('ToggleRecipes', 'MostrarReceitas')" />
</template>
